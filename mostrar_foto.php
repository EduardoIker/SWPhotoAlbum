...
<html>
	<head>
		...
		/********** Es mejor colocar este código aquí y no en el archivo '.js', ya que suele dar problemas ***********/	
			// Cargar el paquete de visualización y de gráficos de Google
			google.load('visualization', '1', {'packages':['corechart']});
			  
			// Establecer la función a la que se debe llamar una vez se hayan cargado los paquetes anteriores
			...
			function drawChart() {
			  ...
			  // Crear el "modelo de datos" a través de los datos recibidos en formato JSON
			  var data = new google.visualization.DataTable(jsonData);

			  // Instanciar y situar el gráfico con el "modelo de datos" creado anteriormente
